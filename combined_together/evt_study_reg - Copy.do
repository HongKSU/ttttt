...
*/
   ...
   reghdfe `car1' roa taxdiff total_cites pac_size vreal roa netloss ,  absorb(PERMNO year)  vce(robust)
   estadd local fef Yes
   estadd local fet Yes
   est store m5, title(model 5)

 
   reghdfe `car1' roa  taxdiff total_cites pac_size vreal roa netloss market_leverage ,  absorb(PERMNO year)  vce(robust)
   estadd local fef Yes
   estadd local fet Yes
   est store m6, title(model 6)
   
   reghdfe `car1' roa  taxdiff total_cites pac_size vreal roa netloss market_leverage cashFlow ,  absorb(PERMNO year)  vce(robust)
   estadd local fef Yes
   estadd local fet Yes
   est store m7, title(model 7)
   }
   ...
   esttab   m1 m2 m3 m4 m5 m6 m7 m8  using "$outputPath\f_all_car_`i'_reg_fe.tex", replace ///
