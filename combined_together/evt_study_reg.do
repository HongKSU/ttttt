...
estout m1 m2 m3, cells(b(star fmt(3)) se(par fmt(2)))  legend label varlabels(_cons Constant)  stats( df_r r2, fmt(0 4 ) label(N R-sqr ))
*/
esttab  m0 m1 m2 m3 m4 m5 m6 using "C:\Users\lihon\report\car_`i'_reg_fe.tex", replace ///
...
estpost tabstat  tax_group taxdiff, c(stat) stat(mean median sd min max n)  
